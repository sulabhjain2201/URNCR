...

{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(pref.getLogintype()==2)
        {
			...
			{*/
            url="http://urncr.com/CarrxonWebServices/ws/get_office_chat.php?user_id="+pref.getOfficeId()+"&friend_id="+msgPatient.getPatient_id();
            //}
...
//true for office-patient chat and false for doctor-patient chat
        ...
        else
        {
            ...
            url="http://urncr.com/CarrxonWebServices/ws/get_office_chat.php?user_id="+pref.getUserId()+"&friend_id="+msg.getOffice_id();
            ...
            public void onClick(View arg0) {
                ...
                if(!etMessage.getText().toString().equals(""))
                {
                    ...
                    if(pref.getLogintype()==2)
                    {
                        ...
                        url="http://urncr.com/CarrxonWebServices/ws/send_chat_office.php?user_id="+pref.getOfficeId()+"&friend_id="+msgPatient.getPatient_id()+"&chat="+etMessage.getText().toString()+"&conv_id="+conv_id+"&status=doctor_office&chat_time="+Cons.convertDateToString(new Date(), "yyyy-MM-dd HH:mm:ss");
                    ...
                    else
                    {
                        ...
                        url="http://urncr.com/CarrxonWebServices/ws/send_chat_office.php?user_id="+pref.getUserId()+"&friend_id="+msg.getOffice_id()+"&chat="+etMessage.getText().toString()+"&conv_id="+conv_id+"&status=patient&chat_time="+Cons.convertDateToString(new Date(), "yyyy-MM-dd HH:mm:ss");
                    }
